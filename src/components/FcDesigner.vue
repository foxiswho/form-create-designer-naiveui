        ...
        <n-layout-content>
            <n-layout has-sider style="height: 100%;" :key="locale && locale.name">
                ...
                <n-layout class="_fc-m">
                    <n-layout-header class="_fc-m-tools" height="45">
                        ...
                        <div class="_fc-m-tools-r">
                            <template v-if="!inputForm.state">
                                ...
                                <n-button v-if="getConfig('showSaveBtn', false)" type="success" strong secondary size="small"
                                           @click="handleSave"><i class="fc-icon icon-save-online"></i> {{
                                        t('props.save')
                                    }}
                                </n-button>
                                <n-button type="primary" strong secondary size="small"
                                ...
                                <n-popconfirm
                                    ...
                                    <template #trigger>
                                        <n-button type="error" strong secondary size="small"><i
                  ...
                  <!---内容 --->
                    <n-layout-content class="_fc-m-con" style="height: 100%;">
