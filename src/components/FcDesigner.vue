        ...
        <n-layout-content style="height: 100%;">
            <n-layout has-sider style="height: 100%;" :key="locale && locale.name">
                ...
                <n-layout class="_fc-m">
                    <n-layout-header class="_fc-m-tools" style="height: 40px;padding: 0 20px">
                        ...
                        <div class="_fc-m-tools-r">
                            <template v-if="!inputForm.state">
                                ...
                                <n-button type="info" strong secondary size="tiny" style="margin-left: 10px"
                                ...
                                <n-popconfirm
                                    ...
                                    <template #trigger>
                                        <n-button type="error" strong secondary size="tiny"  style="margin-left: 10px;margin-right: 10px"><i
                                ...
                                <n-dropdown trigger="click" size="small" v-if="handle && handle.length" :options="changeLange()">
                                    <n-button class="_fd-m-extend" plain size="tiny">
                                        <i class="fc-icon icon-more"></i>
                                    </n-button>
                                </n-dropdown>
                            ...
                            <div class="_fd-input-btn">
                                ...
                                <n-switch size="small" :value="inputForm.state" inline-prompt
                                           @update:value="openInputData"/>
                            </div>
                        </div>
                    </n-layout-header>
                  <!---内容 --->
                    <n-layout-content class="_fc-m-con" style="height: calc(100% - 40px);">
...
export default defineComponent({
    ...
    setup(props) {
        ...
        watch(() => locale.value, (n) => {
            ...
            console.log('baseForm.rule.field',field)
            console.log('baseForm.rule.baseRule.value',baseRule.value)
